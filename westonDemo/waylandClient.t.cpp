...
int main(int argc, char **argv) {
    ...
    shell_surface = wl_shell_wm_get_shell_surface(shell, surface,WINDOW_MANAGER_SHELL_SURFACE_TYPE_TYPE_CAR_SURROUND, 0, 0, 0);
    ...
    wl_shell_surface_set_title(shell_surface,"SAICTEST");
    wl_shell_surface_set_window_geometry(shell_surface,100,100,WIDTH,HEIGHT);
