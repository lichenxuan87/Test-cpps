...
int main( void )
{
    ...
    // Projection matrix : 45� Field of View (Vertical), 4:3 ratio, display range : 0.1 unit <-> 100 units
    mat4 Projection = perspective(radians(90.0f), 4.0f / 3.0f, 0.1f, 10.0f);
    // Or, for an ortho camera :
    //mat4 Projection = ortho(-10.0f,10.0f,-10.0f,10.0f,0.0f,100.0f); // In world coordinates

    // Camera matrix
    mat4 View       = lookAt(
                                vec3(0,0,1), // Camera is at (4,3,3), in World Space
    ...
    quat myQuaternion = angleAxis(radians(60.f), vec3(0.0f, 1.f, 0.f)); // Rotate xx degrees around axis
