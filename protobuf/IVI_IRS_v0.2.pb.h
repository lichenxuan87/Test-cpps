...
#ifndef PROTOBUF_IVI_5fIRS_5fv0_2e2_2eproto__INCLUDED
#define PROTOBUF_IVI_5fIRS_5fv0_2e2_2eproto__INCLUDED
...
class Contrlinfo : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:Contrlinfo) */ {
 ...
 private:
  ...
  friend struct  protobuf_IVI_5fIRS_5fv0_2e2_2eproto::TableStruct;
};
// -------------------------------------------------------------------
...
class RespondInfo : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:RespondInfo) */ {
 public:
  ...
  void clear_failimageurl();
  static const int kFailImageUrlFieldNumber = 11;
  const ::std::string& failimageurl() const;
  void set_failimageurl(const ::std::string& value);
  #if LANG_CXX11
  void set_failimageurl(::std::string&& value);
  #endif
  void set_failimageurl(const char* value);
  void set_failimageurl(const char* value, size_t size);
  ::std::string* mutable_failimageurl();
  ::std::string* release_failimageurl();
  void set_allocated_failimageurl(::std::string* failimageurl);
 ...
 private:
  ...
  ::google::protobuf::internal::InternalMetadataWithArena _internal_metadata_;
  ::google::protobuf::internal::ArenaStringPtr failimageurl_;
...
#if LANG_CXX11
inline void RespondInfo::set_failimageurl(::std::string&& value) {
...
#endif
inline void RespondInfo::set_failimageurl(const char* value) {
...
inline void RespondInfo::set_failimageurl(const char* value, size_t size) {
...
inline ::std::string* RespondInfo::mutable_failimageurl() {
...
inline ::std::string* RespondInfo::release_failimageurl() {
...
inline void RespondInfo::set_allocated_failimageurl(::std::string* failimageurl) {
...
#endif  // PROTOBUF_IVI_5fIRS_5fv0_2e2_2eproto__INCLUDED
